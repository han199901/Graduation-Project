...
public class ExamPaperServiceImpl implements ExamPaperService {
    ...
    private void examPaperFromVO(ExamPaperEditRequest examPaperEditRequest, ExamPaper examPaper, List<ExamPaperTitleItem> titleItemsVM) {
        Integer gradeLevel = examPaperEditRequest.getSubjectId();
        ...
        List<String> dateTimes = examPaperEditRequest.getLimitDateTime();
    ...
    private List<ExamPaperTitleItemObject> frameTextContentFromVM(List<ExamPaperTitleItem> titleItems) {
    ...
    @Override
    public PageInfo<ExamPaper> page(ExamPaperPageRequest requestVM) {
        return PageHelper.startPage(requestVM.getPageIndex(), requestVM.getPageSize(), "id desc").doSelectPageInfo(() ->
                examPaperMapper.page(requestVM));
    }

    @Override
    public PageInfo<ExamPaper> taskExamPage(ExamPaperPageRequest model) {
        return PageHelper.startPage(model.getPageIndex(), model.getPageSize(), "id desc").doSelectPageInfo(() ->
                examPaperMapper.taskExamPage(model));
    }
    ...
    public ExamPaperEditRequest examPaperToVO(Integer id) {
        ...
        List<ExamPaperTitleItem> examPaperTitleItemVMS = examPaperTitleItemObjects.stream().map(t -> {
            ExamPaperTitleItem tTitleVM = modelMapper.map(t, ExamPaperTitleItem.class);
    ...
    @Override
    @Transactional
    public ExamPaper savePaperFromVO(ExamPaperEditRequest model, User currentUser) {
        ActionEnum actionEnum = (model.getId() == null) ? ActionEnum.ADD : ActionEnum.UPDATE;
        Date now = new Date();
        List<ExamPaperTitleItem> titleItemsVM = model.getTitleItems();
        ...
        if (actionEnum == ActionEnum.ADD) {
            ...
            examPaperFromVO(model, examPaper, titleItemsVM);
    ...
    @Override
    public int updateByIdFilter(ExamPaper examPaper) {
